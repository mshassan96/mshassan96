### Hi, I'm Mian Salman Hassan 👋

Full-stack developer specializing in the JavaScript/Node ecosystem, from React and Next.js frontends to NestJS APIs, with 7+ years shipping production e-commerce, dashboard, and AI-powered platforms.
...
Currently the sole engineer building an AI-powered platform end to end, integrating the OpenAI API and a RAG pipeline over structured content.

#### 💞️ Open to Collaborating On

Full-stack JavaScript/TypeScript projects, AI-integrated features (OpenAI/RAG), and e-commerce or backend architecture work. Always happy to dig into a new problem.
